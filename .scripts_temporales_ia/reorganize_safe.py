...
old_btn = re.compile(r'<button id="btnGuest" class="btn-outline-v2" style="width: 100%; margin-top: 10px;">\s*👀 Entrar como invitado\s*</button>')
new_btn = r'<button id="btnGuest" class="btn-outline-v2" style="width: 100%; margin-top: 10px; opacity: 0.5; cursor: not-allowed;" disabled>\n          👀 Entrar como invitado (Próximamente)\n        </button>'

text = old_btn.sub(new_btn, text)
