...
old_header_block = r"""<div class="match-header-strip-v2">
...
new_header_block = r"""<div class="match-header-strip-v2">
...
text = re.sub(old_header_block, new_header_block, text)

with open('v2.html', 'w', encoding='utf-8') as f:
    f.write(text)

print("Timer restored and moved!")
